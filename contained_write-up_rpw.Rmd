...
---
```{r}
setwd("/Users/Ryan/Desktop/Spring/EDAV/EDAV_HW1")
...
ggplot(plotdata,aes(tool,proportion)) + geom_bar(stat = 'identity') + theme_fivethirtyeight() + scale_color_tableau() + ggtitle('Survey Tool Familiarity') + xlab("") + ylab("")  + scale_y_continuous(labels=percent, limits = c(0,1)) + theme(axis.text.x = element_text(angle = 90, hjust = 1))
